...
class Property(Base):
    ...
    transaction_target = Column(String(50), comment="交易標的 (房地/建物/土地/車位)")
    ...
    transaction_purpose = Column(String(500), comment="交易目的")

    # Building Information
    building_type = Column(String(100), index=True, comment="建物型態 (公寓/華廈/住宅大樓等)")
    ...
    main_building_area = Column(Numeric(15, 2), comment="主建物面積")
    auxiliary_building_area = Column(Numeric(15, 2), comment="附屬建物面積")
    balcony_area = Column(Numeric(15, 2), comment="陽台面積")
    ...
    parking_type = Column(String(50), comment="車位類別 (坡道平面/坡道機械/升降平面/升降機械等)")
